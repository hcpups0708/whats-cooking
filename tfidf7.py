...
sel_tfidf= SelectKBest(f_classif,k=2000)
...
sel_ing=SelectKBest(f_classif,k=500)
...
X=np.concatenate((X_tfidf_sel,X_ing_sel),axis=1)
print("X",X.shape)
X_unknown=np.concatenate((X_unknown_tfidf_sel,X_unknown_ing_sel),axis=1)
...
testdf[['id' , 'cuisine' ]].to_csv("submission7.csv",index = False)
